...
/**
 * Adds a string of text to be displayed to a scene,
 *
 * @param scene a pointer to a scene returned from scene_init()
 * @param txt a pointer of text_t
 */
void scene_add_text(scene_t *scene, text_t *txt);

/**
 * return the size of the list of texts to be displayed
 *
 * @param scene a pointer to a scene returned from scene_init()
 */
...
/**
 * Gets the text at a given index in a scene.
 *
 * @param scene a pointer to a scene returned from scene_init()
 * @param index the index of the body in the scene (starting at 0)
 * @return a pointer to the body at the given index
